<?php echo $this->html->form("index/addComment/{$urlfriendly}","post",'id="commentform"'); ?>
	...
	<p>
		...
		<?php echo $this->html->textField("author",'value="'.$cookie["author"].'" size="22" tabindex="1"'); ?>
		<?php echo $this->html->validateError("author"); ?>
	</p>
	<p>
		<label for="email">Email (requerido)</label>
		<?php echo $this->html->textField("email",'value="'.$cookie["email"].'" size="22" tabindex="2"'); ?>
		<?php echo $this->html->validateError("email"); ?>
	</p>
	<p>
		<label for="url">Website/Blog</label>
		<?php echo $this->html->textField("url",'value="'.$cookie["url"].'" size="22" tabindex="3"'); ?>
